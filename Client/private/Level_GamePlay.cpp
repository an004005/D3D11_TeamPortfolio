...
HRESULT CLevel_GamePlay::Ready_Prototypes()
{
	...
	CFactoryMethod::MakeTWallPrototype(m_pDevice, m_pContext);
...
HRESULT CLevel_GamePlay::Ready_Layer_BackGround(const _tchar * pLayerTag)
{
	...
	FAILED_CHECK(pGameInstance->Clone_GameObject(LEVEL_NOW, PLAYERTEST_LAYER_MAP, TEXT("Prototype_GameObject_SkyBox")));
	...
	FAILED_CHECK(pGameInstance->Clone_GameObject(PLAYERTEST_LAYER_MAP, TEXT("Prototype_GameObject_ScarletMap"), &json));
...
HRESULT CLevel_GamePlay::Ready_Layer_Effect()
{
	...
	pGameInstance->Clone_GameObject(L"Layer_PostVFX", L"ProtoPostVFX_Teleport", &Teleport);

	Json SuperSpeed = CJsonStorage::GetInstance()->FindOrLoadJson("../Bin/Resources/VFX/PostVFX/SuperSpeed.json");
	pGameInstance->Clone_GameObject(L"Layer_PostVFX", L"ProtoPostVFX_SuperSpeed", &SuperSpeed);
