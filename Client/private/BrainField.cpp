	...
	m_pFSM = CFSMComponentBuilder()
		...
		.AddState("BrainFieldOpen_c01")
			.OnStart([this]
			{
				...
				m_CableModels[HEAD_1]->GetPlayAnimation()->SetTickPerSec(48.f);

				m_CableModels[HEAD_2]->SetPlayAnimation("AS_BrainFieldOpen_c01_co0100_2");
				m_CableModels[HEAD_2]->GetPlayAnimation()->SetTickPerSec(48.f);

				m_CableModels[HEAD_3]->SetPlayAnimation("AS_BrainFieldOpen_c01_co0100_3");
				m_CableModels[HEAD_3]->GetPlayAnimation()->SetTickPerSec(48.f);
		...
		.AddState("BrainFieldOpen_c02")
			.OnStart([this]
			{
				...
				m_CableModels[BACK_1]->GetPlayAnimation()->SetTickPerSec(48.f);
				m_CableModels[BACK_2]->SetPlayAnimation("AS_BrainFieldOpen_c02_co0101_2");
				m_CableModels[BACK_2]->GetPlayAnimation()->SetTickPerSec(48.f);
				m_CableModels[BACK_3]->SetPlayAnimation("AS_BrainFieldOpen_c02_co0101_3");
				m_CableModels[BACK_3]->GetPlayAnimation()->SetTickPerSec(48.f);
				m_CableModels[BACK_4]->SetPlayAnimation("AS_BrainFieldOpen_c02_co0101_4");
				m_CableModels[BACK_4]->GetPlayAnimation()->SetTickPerSec(48.f);
				m_CableModels[BACK_5]->SetPlayAnimation("AS_BrainFieldOpen_c02_co0101_5");
				m_CableModels[BACK_5]->GetPlayAnimation()->SetTickPerSec(48.f);
