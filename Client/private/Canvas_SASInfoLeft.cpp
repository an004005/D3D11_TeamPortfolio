...
HRESULT CCanvas_SASInfoLeft::Render()
{
	...
	CGameInstance::GetInstance()->Render_Font(L"Pretendard32", L"츠구미 나자르", vPosition + _float2(150.0f, 90.0f), 0.f, { 0.35f, 0.35f }, { 1.0f, 0.99f, 0.87f, 1.0f });
	...
	if (1000 <= iHp)
	{
		...
		CGameInstance::GetInstance()->Render_Font(L"Pretendard32", szChildTag, vPosition + _float2(230.0f, 27.0f), 0.f, fFontSize, { 1.0f, 0.99f, 0.87f, 1.0f });
		wsprintf(szChildTag, TEXT("/ %u"), iMaxHP);
		CGameInstance::GetInstance()->Render_Font(L"Pretendard32", szChildTag, vPosition + _float2(281.0f, 27.0f), 0.f, fFontSize, { 1.0f, 0.99f, 0.87f, 1.0f });
	}
	else
	{
		wsprintf(szChildTag, TEXT("%u"), iHp);
		CGameInstance::GetInstance()->Render_Font(L"Pretendard32", szChildTag, vPosition + _float2(251.0f, 27.0f), 0.f, fFontSize, { 1.0f, 0.99f, 0.87f, 1.0f });
		wsprintf(szChildTag, TEXT("/ %u"), iMaxHP);
		CGameInstance::GetInstance()->Render_Font(L"Pretendard32", szChildTag, vPosition + _float2(291.0f, 27.0f), 0.f, fFontSize, { 1.0f, 0.99f, 0.87f, 1.0f });
	}
