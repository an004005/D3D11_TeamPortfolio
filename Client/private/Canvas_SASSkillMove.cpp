...
void CCanvas_SASSkillMove::UseSkill_Tick()
{
	...
	if (true == m_pPlyaer->Get_SASSkillInput(0))
	{
		...
		if (ESASType::SAS_NOT != eSASType && fCurrentEnergy > fMinEnergy)
		{
			...
			dynamic_cast<CSASSkillGaugeUI*>(Find_ChildUI(L"SASSkill_Gauge1Back"))->Set_GaugeBackType(eSASType, fCurrentEnergy);
		}
	}
	else
	{
	...
	if (true == m_pPlyaer->Get_SASSkillInput(1))
	{
		...
		if (ESASType::SAS_NOT != eSASType && fCurrentEnergy > fMinEnergy)
		{
			...
			dynamic_cast<CSASSkillGaugeUI*>(Find_ChildUI(L"SASSkill_Gauge2Back"))->Set_GaugeBackType(eSASType, fCurrentEnergy);
		}
	}
	else
	{
	...
	if (true == m_pPlyaer->Get_SASSkillInput(2))
	{
		...
		if (ESASType::SAS_NOT != eSASType && fCurrentEnergy > fMinEnergy)
		{
			...
			dynamic_cast<CSASSkillGaugeUI*>(Find_ChildUI(L"SASSkill_Gauge3Back"))->Set_GaugeBackType(eSASType, fCurrentEnergy);
		}
	}
	else
	{
	...
	if (true == m_pPlyaer->Get_SASSkillInput(3))
	{
		...
		if (ESASType::SAS_NOT != eSASType && fCurrentEnergy > fMinEnergy)
		{
			...
			dynamic_cast<CSASSkillGaugeUI*>(Find_ChildUI(L"SASSkill_Gauge4Back"))->Set_GaugeBackType(eSASType, fCurrentEnergy);
		}
	}
	else
	{
