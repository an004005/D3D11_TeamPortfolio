...
HRESULT CLevel_UI::Ready_Layer_UI(const _tchar* pLayerTag)
{
	...
	//FAILED_CHECK(pGameInstance->Clone_GameObject(pLayerTag, L"Shader_UI", &json));

	//json = CJsonStorage::GetInstance()->FindOrLoadJson("../Bin/Resources/UI/UI_PositionData/Canvas_BrainField.json");
	//FAILED_CHECK(pGameInstance->Clone_GameObject(pLayerTag, L"Canvas_BrainField", &json));
