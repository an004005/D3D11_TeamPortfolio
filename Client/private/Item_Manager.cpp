...
void CItem_Manager::ItemInfo_Intiialize()
{
	...
	m_vecItem.emplace_back(L"회복(소) 젤리\n", tItemInfo);
	...
	tItemInfo.szItemEx[2] = L" ";
	tItemInfo.szItemEx[3] = L" ";
	m_vecItem.emplace_back(L"회복(중) 젤리\n", tItemInfo);
	...
	tItemInfo.szItemEx[2] = L" ";
	tItemInfo.szItemEx[3] = L" ";
	m_vecItem.emplace_back(L"회복(대) 젤리\n", tItemInfo);
	...
	tItemInfo.szItemEx[2] = L" ";
	tItemInfo.szItemEx[3] = L" ";
	m_vecItem.emplace_back(L"전체: 회복(소) 젤리\n", tItemInfo);
	...
	tItemInfo.szItemEx[2] = L" ";
	tItemInfo.szItemEx[3] = L" ";
	m_vecItem.emplace_back(L"전체: 회복(중) 젤리\n", tItemInfo);
	...
	tItemInfo.szItemEx[2] = L" ";
	tItemInfo.szItemEx[3] = L" ";
	m_vecItem.emplace_back(L"전체: 회복(대) 젤리\n", tItemInfo);
	...
	tItemInfo.szItemEx[2] = L" ";
	tItemInfo.szItemEx[3] = L" ";
	m_vecItem.emplace_back(L"SAS 보급수\n", tItemInfo);
	...
	tItemInfo.szItemEx[3] = L" ";
	m_vecItem.emplace_back(L"묘호 무라마사\n", tItemInfo);
	...
	tItemInfo.szItemEx[2] = L"다루기 쉽다. 고대 명검의 이름이 붙어 있다.";
	tItemInfo.szItemEx[3] = L" ";
	m_vecItem.emplace_back(L"무기 테스트\n", tItemInfo);
	...
	tItemInfo.szItemEx[2] = L"다루기 쉽다. 고대 명검의 이름이 붙어 있다.";
	tItemInfo.szItemEx[3] = L" ";
	m_vecItem.emplace_back(L"무기 테스트2\n", tItemInfo);
	...
	m_vecItem.emplace_back(L"수수께끼의 텍스트 데이터\n", tItemInfo);

	tItemInfo.szItemEx[0] = L"구 토벌군병원에서 주운 텍스트 데이터.";
	tItemInfo.szItemEx[1] = L"누군가의 개인적인 메모 같다. 괴이의 습격으로 인해";
	tItemInfo.szItemEx[2] = L"병원을 포기하면서 회수되지 않고 그대로 버려진 모양.";
	tItemInfo.szItemEx[3] = L" ";
	m_vecItem.emplace_back(L"기타 테스트\n", tItemInfo);
}
