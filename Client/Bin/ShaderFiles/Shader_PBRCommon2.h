#ifndef __SHADER_PBR2_HLSL__
#define __SHADER_PBR2_HLSL__
...
float3 LightSurface2(
    float3 Lo, float3 N, float3 lightColor, float3 lightDirection,
    float3 albedo, float roughness, float metalness)
{
	...
	float3 directLighting = 0.0;
	{
		...
		float3 Lradiance = lightColor * cosLo * 0.5f;
