...
BEGIN(Client)
class CAI_CH0500_AnimInstance;

class CAI_CH0500 : public CScarletCharacter
{
public:
...
private:
	CAI_CH0500(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CAI_CH0500(const CAI_CH0500& rhs);
	virtual ~CAI_CH0500() = default;
...
private:
	...
	CAI_CH0500_AnimInstance* m_pASM = nullptr;
...
public:
	static CAI_CH0500* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
