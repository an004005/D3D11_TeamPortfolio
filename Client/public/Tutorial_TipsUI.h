...
class CTutorial_TipsUI final : public CUI
{
private:
	CTutorial_TipsUI(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTutorial_TipsUI(const CTutorial_TipsUI& rhs);
...
public:
	static CTutorial_TipsUI* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
