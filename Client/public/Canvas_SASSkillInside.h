...
class CCanvas_SASSkillInside : public CCanvas
{
public:
...
protected:
	CCanvas_SASSkillInside(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CCanvas_SASSkillInside(const CCanvas_SASSkillInside& rhs);
...
public:
	static CCanvas_SASSkillInside* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
