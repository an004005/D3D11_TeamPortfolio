...
namespace Engine
{
	...
	enum ECOLLIDER_TYPE_BIT
	{
		...
		CTB_TELEPORT_OBJ = 1 << CT_TELEPORT_OBJ,
		CTB_SPECAILCHILD_OBJ = 1 << CT_SPECAILCHILD_OBJ,
	};
	...
	inline ECOLLIDER_TYPE_BIT GetCollTypeBit(ECOLLIDER_TYPE eType)
	{
		static array<ECOLLIDER_TYPE_BIT, CT_END> collTypeBits
		{
			...
			CTB_TRIGGER_FOR_PLAYER, CTB_TRIGGER_FOR_MONSTER, CTB_STATIC, CTB_MONSTER_PART, CTB_MONSTER_RANGE, 
			CTB_PLAYER_RANGE, CTB_PARTICLE, CTB_TELEPORT_OBJ
		};
